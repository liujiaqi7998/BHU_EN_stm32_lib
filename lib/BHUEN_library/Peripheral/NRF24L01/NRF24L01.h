...
//-------宏定义引脚--------
#define NRF_CE_PIN          B10    //A17
#define NRF_CSN_PIN         B12    //A21

#define NRF_SCK_PIN         B13   //A22
#define NRF_MOSI_PIN        B14		//A29   

#define NRF_MISO_PIN        B15   //B14
#define NRF_IRQ_PIN         B11   //B15

// 用户变量 
extern uint8_t nrf_rx_buff[];                 // 接收数据缓冲区
extern uint8_t nrf_tx_buff[];                 // 发送数据缓冲区


// 用户函数
extern void  nrf_init(void);
extern void  nrf_send_packet(uint8_t* p);
extern uint8_t nrf_rece_packet(uint8_t* p);
extern void clean_buff(uint8_t *p);
#endif
