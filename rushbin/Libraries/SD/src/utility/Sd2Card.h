...
// include pins_qiArdlib.h or variant.h depending on architecture, via qiArdlib.h
#include <qiArdlib.h>
...
uint8_t const  SD_CHIP_SELECT_PIN = PA4;
#else
uint8_t const  SD_CHIP_SELECT_PIN = SDCARD_SS_PIN;
#endif

// The following three pins must not be redefined for hardware SPI,
// so ensure that they are taken from pins_qiArdlib.h or variant.h, depending on architecture.
#ifndef SDCARD_MOSI_PIN
/** SPI Master Out Slave In pin */
uint8_t const  SPI_MOSI_PIN = PA7;
/** SPI Master In Slave Out pin */
uint8_t const  SPI_MISO_PIN = PA6;
/** SPI Clock pin */
uint8_t const  SPI_SCK_PIN = PA5;
#else
